...
local exec_binds = {
    ...
    {'Print',                "grimblast --notify save area $XDG_PICTURES_DIR/screenshot_$(date +'%F_%T.png')"},
    {'SHIFT + Print',        "grimblast --notify --freeze save area $XDG_PICTURES_DIR/screenshot_$(date +'%F_%T.png')"}
}
